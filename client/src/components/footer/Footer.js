...
const Footer = () => {
  return (
    <>
        <footer className="relative bg-slate-900 text-white px-4 sm:px-8 lg:px-16 xl:px-40 2xl:px-64 py-12 lg:py-8">
        <a href="/">
                <img
                    src="./assets/images/logo.png"
                    alt="logo"
                    className="relative z-8 drop-shadow-lg pb-8"
                />
         </a>
        <div className="flex flex-col md:flex-row">
          ...
          <div className="w-full lg:w-2/6 lg:mx-4 lg:pr-8">            
            ...
            <form className="flex items-center mt-6">
              <div className="w-full">
                ...
                >
                  Subscribe to latest Resaearch Updates
                </label>
                <div className="relative">
                  ...
                  <button
                    type="submit"
                    className=" hover:bg-teal-400 text-white px-4 py-2 text-sm font-bold rounded absolute top-0 right-0 my-2 mr-2  bg-gradient-to-r from-[#0176bc] via-purple-500 to-[#e82e5d]"
                  >
                    Subscribe
                  </button>
                </div>
            ...
            <ul className="mt-4">
              <li>
                ...
                >
                  ...
                  <span className="ml-3">Dummy Address</span>
                </a>
              </li>
              <li className="mt-4">
                <a
              ...
              <li className="mt-4">
                ...
                >
                  ...
                  <span className="ml-3">+00000000000</span>
                </a>
              </li>
              <li className="mt-4">
                <a
                ...
                >
                  ...
                  <span className="ml-3">text@example.com</span>
                </a>
              </li>
            </ul>
          </div>
          ...
          <div className="w-full lg:w-1/6 mt-8 lg:mt-0 lg:mx-4">
            <h5 className="uppercase tracking-wider font-semibold text-gray-500">
              Get free updates on research tools to enhance your research.
            </h5>
        ...
        <p className="text-sm text-gray-400 mt-6 text-center">
              Copyright &copy; 2024 All Rights Reserved by ResearchDeveloper
            </p>
      </footer>
